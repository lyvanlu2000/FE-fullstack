            ...
            <div className="contetn-down">
                ...
                {isShowDetailInfor===false && 
                    <div className="short-infor">
                        ...
                        <span className="see-detail" onClick={()=>this.showHideDetailInfor(true)}>
                        <FormattedMessage id="patient.extra-infor.more"/>
                        </span>
                    </div>
                }
                ...
                <>
                <div className="title-price"><FormattedMessage id="patient.extra-infor.text-price"/>:</div>
                <div className="detail-infor">
                    <div className="price">
                        <span className="left"><FormattedMessage id="patient.extra-infor.text-price"/></span>
